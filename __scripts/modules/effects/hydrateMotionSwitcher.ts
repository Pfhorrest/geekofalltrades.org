...
export const hydrateMotionSwitcher = () => {
  ...
  const reducedMotionAttribute: string = html.getAttribute("data-reduced-motion") || "";
  let reducedMotionNumber: number = parseInt(reducedMotionAttribute.split("-")[0]) || 0;
