...
export const hydrateColorSwitcher = () => {
    ...
    if (footer) {
        ...
        const createControl = (container, className, text) => { var _a; return (_a = document.getElementById(container)) === null || _a === void 0 ? void 0 : _a.appendChild(Object.assign(document.createElement("a"), {
            className,
            innerText: text,
            role: "button",
        })); };
