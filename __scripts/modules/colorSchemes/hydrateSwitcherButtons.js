...
export const hydrateSwitcherButtons = () => {
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (footer) {
            ...
            const colorSchemeSwitcher = footer.appendChild(document.createElement("div"));
            colorSchemeSwitcher.classList.add("colorSchemeSwitcher");
            // Reusable function to create a control with the given class and text
            const createControl = (className, text) => colorSchemeSwitcher.appendChild(Object.assign(document.createElement("a"), {
                className,
                innerText: text,
                role: "button",
            }));
...
//# sourceMappingURL=hydrateSwitcherButtons.js.map