...
### Full-Stack Developer | Twisted Rope

**Remote from Ojai, CA to Buffalo, NY | 2021 – 2024**

- Delivered 30+ client sites and applications, from simple static sites to large-scale Next.js/React SPAs.
- Adapted quickly to diverse stacks (vanilla JS, PHP, React, etc.) based on client needs, working effectively with both modern frameworks and legacy codebases.
...
### Art Director | The Monterey Company
...
**Santa Barbara, CA | 2011 – 2012**

- Built e-commerce features using Ruby on Rails, HTML, SCSS, and JavaScript.
- Created motion graphic ads to support marketing campaigns.

### Graphic & Web Designer | Stratus Media Group

**Santa Barbara, CA | 2010 – 2011**
...
Actively enhancing technical capabilities through sustained professional development initiatives. Projects include:

- Converted personal site CSS to modular SASS architecture for improved maintainability
- Migrated JavaScript codebase to modular TypeScript for type safety and better tooling
- Developed PrevHP, a custom lightweight PHP framework incorporating Next.js architectural concepts
- Modernized development workflow: migrated from XAMPP to npm-based dev environment with PHP dev server, concurrent TypeScript/SASS compilation, and proper staging/production deployment pipeline using ssh/git/rsync instead of FTP
- Added comprehensive inline documentation across all codebases
...
### Senior Administrator (Volunteer) | The Philosophy Chat (Discord)
...
**BA Philosophy, UC Santa Barbara** – Highest Honors, 3.9 GPA

**AA Multimedia, Santa Barbara City College** – Honors, 4.0 GPA

-----

## PORTFOLIO & PERSONAL PROJECTS

**Portfolio:** geekofalltrades.org

**GitHub:** github.com/Pfhorrest

**Personal projects:** retro game development, fiction writing, philosophy, and photography.