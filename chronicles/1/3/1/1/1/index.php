<?php $title = "The Chronicles of Quelouva (7x01): Nurbal Colony: Part 1, Episode 1 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(7x01) Nurbal Colony: Part 1, Episode 1</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../2">
							Nurbal Colony: Part 1, Episode 2
						</a>
					</p>
