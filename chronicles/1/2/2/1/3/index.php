<?php $title = "The Chronicles of Quelouva (1x18): Darak Meij: Part 1, Episode 3 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(1x18) Darak Meij: Part 1, Episode 3</h2>
					...
					<p>
						Finding Wreber allied with a Meij, in love with him even, and uninterested in joining with her evil plans, Mav slaughtered both of them &ndash; unbeknownst to her, before the eyes of their just-hatched child, who fled deeper into the wilderness, forever traumatized by the sight of Mav slaughtering his parents.
					</p>
