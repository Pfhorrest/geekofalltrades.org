...
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>
				...
				<section>
					...
					<p>
						<strong>Next:</strong>
						<a href="../3">
							Life in Another World: Part 1, Episode 3
						</a>
					</p>
