<?php $title = "The Chronicles of Quelouva: Life in Another World: Part 2 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>Life in Another World: Part 2</h2>
					
					<ol>
						<li>
							In Life in Another World: Part 2,
