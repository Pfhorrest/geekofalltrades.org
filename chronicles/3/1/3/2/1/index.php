<?php $title = "The Chronicles of Quelouva (4x22): Death and the Other World: Part 2, Episode 1 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(4x22) Death and the Other World: Part 2, Episode 1</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../2">
							Death and the Other World: Part 2, Episode 2
						</a>
					</p>
