<?php $title = "The Chronicles of Quelouva (9x20): Virtuality Immanent: Part 1, Episode 2 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(9x20) Virtuality Immanent: Part 1, Episode 2</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../3">
							Virtuality Immanent: Part 1, Episode 3
						</a>
					</p>
