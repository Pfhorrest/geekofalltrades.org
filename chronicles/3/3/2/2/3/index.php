<?php $title = "The Chronicles of Quelouva (9x15): Virtuality Incarnate: Part 2, Episode 3 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(9x15) Virtuality Incarnate: Part 2, Episode 3</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../../3/1">
							Virtuality Incarnate: Part 3, Episode 1
						</a>
					</p>
