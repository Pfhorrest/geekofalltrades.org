<?php $title = "The Chronicles of Quelouva (9x05): Virtuality Transcendent: Part 2, Episode 2 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(9x05) Virtuality Transcendent: Part 2, Episode 2</h2>
