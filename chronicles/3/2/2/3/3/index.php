<?php $title = "The Chronicles of Quelouva (1x27): Nadir of the Darklight: Part 3, Episode 3 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(1x27) Nadir of the Darklight: Part 3, Episode 3</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../../../1/1/1">
							Falling of the Darklight: Part 1, Episode 1
						</a>
					</p>
