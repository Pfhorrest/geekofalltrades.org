<section>
	...
	<h2>Rising of the Darklight</h2>
	
	<ol>
		<li>
			In Rising of the Darklight,
				...
				<li>
					...
					<ol>
						<li>
							...
							at the climax of a joint military action against Chalmany, Murdock captures the witch lieutenant of the Vampire queen, and discovers that he is strangely immortal.
						</li>
						<li>
							In <a href="2/2">Episode 2</a>,
							Murdock learns that the captured witch is his half-sister, and convinces her that their ultimate interests may be more aligned than she thinks they are.
						</li>
						<li>
							In <a href="2/3">Episode 3</a>,
							as the Elves make war against the Vampires and Orcs rise up against their Human masters, the Vampire Queen abducts the Elven King, with Murdock and Annabelle in pursuit.
						</li>
					</ol>
				</li>
				<li>
