<?php $title = "The Chronicles of Quelouva (3x24): Rising of the Darklight: Part 2, Episode 3 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(3x24) Rising of the Darklight: Part 2, Episode 3</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../../3/1">
							Rising of the Darklight: Part 3, Episode 1
						</a>
					</p>
