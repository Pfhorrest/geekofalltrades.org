				...
				<li>
					...
					<ol>
						<li>
							...
							Metis comes of age and begins a touring business that eventually lures her into the seedy Martian underground, where she narrowly escapes a kidnapping attempt.
						</li>
						<li>
							In <a href="2">Episode 2</a>,
							Metis' attempts to rescue her client lead her to the powers secretly ruling Mars, where she learns of her forgotten past, and then witnesses a war between worlds.
						</li>
						<li>
							In <a href="3">Episode 3</a>,
							Metis is reintroduced to the immortal family she didn't know she had, as they all unite together and then rally humanity to defend from an alien invasion.
						</li>
					</ol>
				</li>
				<li>
				...
				<li>
					...
					<ol>
						<li>
							...
							the Berol, against whom the Ehrban are already at war, attack the Sol system, and Metis is thought by Xio to be killed, though she is secretly rescued by Kron.
						</li>
						<li>
							In <a href="3/2">Episode 2</a>,
							as Sol is overwhelmed by the Berol invasion, a gravitic superweapon on Luna is deployed, then suffers a catastrophic failure that shatters the entire moon.
						</li>
						<li>
							In <a href="3/3">Episode 3</a>,
							as Earth civilization collapses, Xio rushes to recover the copy of Metis from Virtuality, while Metis rushes to Earth to save Xio, and both seem to die with the rest of humanity.
						</li>
					</ol>
				</li>
			</ol>
