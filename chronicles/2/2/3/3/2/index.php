<?php $title = "The Chronicles of Quelouva (3x17): Light of the Foundation: Part 3, Episode 2 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(3x17) Light of the Foundation: Part 3, Episode 2</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../3">
							Light of the Foundation: Part 3, Episode 3
						</a>
					</p>
