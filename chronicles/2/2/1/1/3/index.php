<?php $title = "The Chronicles of Quelouva (2x12): Shadow of the Foundation: Part 1, Episode 3 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(2x12) Shadow of the Foundation: Part 1, Episode 3</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../../2/1">
							Shadow of the Foundation: Part 2, Episode 1
						</a>
					</p>
