<?php $title = "The Chronicles of Quelouva (8x11): Terra Resurgent: Part 1, Episode 2 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(8x11) Terra Resurgent: Part 1, Episode 2</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../3">
							Terra Resurgent: Part 1, Episode 3
						</a>
					</p>
