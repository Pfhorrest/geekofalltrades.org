<?php $title = "The Chronicles of Quelouva (8x25): Sol Resurgent: Part 3, Episode 1 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(8x25) Sol Resurgent: Part 3, Episode 1</h2>
