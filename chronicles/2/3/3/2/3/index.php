<?php $title = "The Chronicles of Quelouva (8x24): Sol Resurgent: Part 2, Episode 3 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(8x24) Sol Resurgent: Part 2, Episode 3</h2>
