<?php $title = "The Chronicles of Quelouva: The Pantheon Series &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>The Pantheon Series</h2>
					
					<ol>
						<li>
							In the Pantheon series,
							...
							<ol>
								<li>
									In <a href="1">Pantheon Genesis</a>,
								...
								<li>
									In <a href="3">Pantheon Synthesis</a>,
