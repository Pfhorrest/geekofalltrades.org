<?php $title = "The Chronicles of Quelouva (5x18): Pantheon Exodus: Part 3, Episode 3 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(5x18) Pantheon Exodus: Part 3, Episode 3</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../../../3/1/1">
							Pantheon Synthesis: Part 1, Episode 1
						</a>
					</p>
