<?php $title = "The Chronicles of Quelouva (5x17): Pantheon Exodus: Part 3, Episode 2 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(5x17) Pantheon Exodus: Part 3, Episode 2</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../3">
							Pantheon Exodus: Part 3, Episode 3
						</a>
					</p>
