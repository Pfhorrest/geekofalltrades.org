<?php $title = "The Chronicles of Quelouva (5x10): Pantheon Exodus: Part 1, Episode 1 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(5x10) Pantheon Exodus: Part 1, Episode 1</h2>
					...
					<p>
						One faction of the Pantheon thinks that they are obligated to stick to the mission given to Keie and Oron by their creator Keius long ago, to watch and observe humanity and not interfere. They note that their isolated project on a small remote continent was very different from what they're talking about doing now here near the middle of the largest continent. They argue that they should <em>at most</em> be teachers, mentors, or guides, if the natives come to them for help, but not rulers, judges, and masters using the natives as a labor force for their own end.
					</p>
					...
					<p>
						<strong>Next:</strong>
						<a href="../2">
							Pantheon Exodus: Part 1, Episode 2
						</a>
					</p>
