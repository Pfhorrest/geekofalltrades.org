<?php $title = "The Chronicles of Quelouva (5x25): Pantheon Synthesis: Part 3, Episode 1 &ndash; by Forrest Cameranesi" ?>
<?php require $_SERVER['DOCUMENT_ROOT'] . "/includes/header-dynamic.php" ?>

				<section>
					
					<h2>(5x25) Pantheon Synthesis: Part 3, Episode 1</h2>
					...
					<p>
						<strong>Next:</strong>
						<a href="../2">
							Pantheon Synthesis: Part 3, Episode 2
						</a>
					</p>
