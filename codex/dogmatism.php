				...
				<section>
					...
					<figure class="invertible">
						<picture>
							...
							<img src="images/philosophical-spectrum-no-dogmatism.jpg"
					...
					<ul>
						...
						<li>
							...
							its negation, <strong>a kind of fideism called dogmatism</strong>.
						</li>
					</ul>
					<p>
					...
					<hr />
					<p>
						I reject dogmatism on pragmatic grounds, as explained previously in my essay on <a href="commensurablism">commensurablism</a>:
					</p>
					<ul>
						<li>
					...
					<p>
						It is fine and even unavoidable that we <em>pick</em> our initial opinions arbitrarily, for no good reason. But when we do, we then have a very high chance of those initial opinions just happening to be incorrect. If we go on to hold those arbitrary opinions (that we just happened into for no solid reason) to be above question, which is the defining characteristic of dogmatism as I mean it here, then we will never change away from those incorrect opinions, and will remain incorrect forever.
					</p>
					<p>
					...
					<p>
						<i>Dogma</i> is the Greek word for "tenet", as in something held to be firmly established or accepted, so by dogmatism I mean ever uncritically accepting "because X said so" as a justification for anything, no matter who the X is, or what it is they've said. In other words, accepting assertions that are made <em>arbitrarily</em>; not for any reason, not "because of..." anything, but "just because"; assertions that some claim is true because it just is, with no further justification to back that claim up; assertions put forth as <em>beyond question</em>, for if they needed no justification to stand then there could be no room to doubt them.
					</p>
					<p>
					...
					<section id="authoritarianism">
						<h3>Against Authoritarianism</h3>
						<p>
					...
					<section id="populism">
						...
						<p>
							Some philosophers, such as Jean-Jacques Rousseau, have put forth arguments that popular opinion rationally should be trusted more than any individual's opinion, on the grounds that if the average individual is <em>even slightly</em> more likely to be right than wrong on any random question, then the more individuals you poll for an answer, the more statistically likely you are to get the right answer, and the collective opinion of the masses is more likely to be right than the opinion of any single random individual.
						</p>
						<p>
							Yet I counter that if instead the average individual is even slightly <em>less</em> likely to be right than wrong on any random question, then the more individuals you poll for an answer, the <em>less</em> statistically likely you are to get the right answer, and the opinion of any single random individual is more likely to be right than the collective opinion of the masses.
						</p>
						<p>
