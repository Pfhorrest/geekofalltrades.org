				...
				<section>
					...
					<figure class="invertible">
						<picture>
							...
							<img src="images/philosophical-spectrum-no-cynicism.jpg"
					...
					<ul>
						...
						<li>
							...
							its negation, <strong>a kind of skepticism called cynicism</strong>.
						</li>
					</ul>
					<p>
						In this essay I will first recap why I am against cynicism, then elaborate more on what exactly is or isn't included in that category.
					</p>
					<hr />
					<p>
						I reject cynicism as a direct consequence of my position <a href="relativism">against relativism</a>. To recap the argument against relativism and explain its consequences against cynicism:
					</p>
					<ul>
						<li>
					...
					<p>
						In rejecting relativism, we stand a much better chance of getting closer to finding answers, if anything like that should turn out to be possible, by <em>trying</em> to find them, proceeding as though we assume that there is something to be found, than if we just assume that there is not, and don't even try. But in order to do that, we must allow ourselves to entertain the possibility of something or another maybe being the correct answer, until we find reason to reject it, rather than rejecting everything out of hand until we find reasons that force us to accept it, which absolute certainty we can never manage.
					</p>
					<hr />
					<p>
						I call this counter-principle "cynicism" merely for lack of a better term. The word <i>cynic</i> is Greek for "dog-like", and was used in ancient philosophy as an insult for, and eventually just the name of, a group of Greek philosophers; but their type of philosophy is not what I'm saying I'm against here. Rather, because those ancient Cynics were skeptics, in the broad sense of methodically doubting and questioning things, "cynicism" has come over time to mean "skepticism", and then further still a particularly negative variety of skepticism.
					</p>
					<p>
						It is in that sense of a bad kind of skepticism that I mean the term, in contrast to the good kind of skepticism I have already endorsed in my previous essay <a href="dogmatism">against dogmatism</a>. More specifically, this bad kind of skepticism that I am calling "cynicism" is the kind that immediately rejects all opinions until they can be conclusively proven beyond any possibility of a doubt. That is, rather than merely saying to be <em>willing</em> to reject an opinion <em>if</em> you find a reason to reject it, but otherwise granting the liberty to think whatever you are inclined to think without being in error, cynicism in the sense that I am against says to reject <em>every</em> opinion <em>unless</em> you can find a reason to <em>keep</em> it.
					</p>
					<p>
					...
					<section id="justificationism">
						<h3>Against Justificationism</h3>
						<p>
						...
						<p>
							When considering reasons to <em>intend</em> something, rather than reasons to <em>believe</em> something, anti-justificationism seems so uncontroversial that it's not even discussed. People generally accept that it is justified to do something, for no particular reason, so long as there is not a good reason <em>not</em> to do it. We don't demand that everybody stop doing anything at all until they can show that what they want to do is justified by the need to do something that is justified by the need to do something that is justified by the need to do something... ad infinitum. We instead just accept that they're free to do whatever there's no reason <em>not</em> to do.
						</p>
						<p>
						...
						<p>
							In contrast, most theories of knowledge &ndash; about what is justified to <em>believe</em>, rather than to <em>intend</em> &ndash; <em>are</em> justificationist in one way or another, though usually only tacitly, without their proponents explicitly realizing it. And a famous trilemma, known by various names such as Agrippa's Trilemma or Munchausen's Tremma, illustrates how this unspoken principle of justificationism leads directly to cynicism in the sense that I mean here, or else instead to something tantamount to <a href="dogmatism">dogmatism, which I have already argued against</a>.
						</p>
						<p>
						...
						<ul>
							...
							<li>
								...
								<p>
									But while that is a <em>necessary</em> feature, I think it is not a <em>sufficient</em> one: mere consistency is not enough to justify opinions in the sense demanded by justificationism, without again falling to dogmatism. For as that whole circular chain of reasons is then collectively unsupported and held as needing no further support besides itself, it is then, as a whole, tantamount to one big foundational, and therefore dogmatist, opinion.
								</p>
								<p>
									A coherentist could alternatively hold that <em>any</em> consistent set of opinions is equally justified. But then, since there are multiple possible sets of consistent opinions, that interpretation of coherentism would once again be tantamount to relativism, in allowing that different, contrary opinions are all correct, relative to whoever holds them, so long as they're consistent with the other opinions of those who hold them.
								</p>
							</li>
						</ul>
						<p>
							Most theories of knowledge are either foundationalist or coherentist, and most of those who reject both of those conclude that therefore knowledge is impossible, seeing infinitism to be as incoherent as I do. But a few philosophers, including Immanuel Kant and Karl Popper, have instead rejected the justificationist principle tacitly underlying all of those positions, and instead say, as do I, that it is not necessary to reject every opinion until you can find reasons to justify it; it is only necessary to reject an opinion <em>if</em> you find reasons to reject it, and it is acceptable to hold any opinion, for no reason at all, until such reasons to reject it are found.
						</p>
						<p>
					...
					<section id="constructivism-scientism">
						<h3>Against Constructivism and Scientism</h3>
						<p>
						...
						<p>
							But in my rejection of scient<em>ism</em>, I am not at all rejecting <em>science</em>. I have great esteem for science and hold it to be the uniquely correct way of building true descriptions of reality. I am only against attempting to reduce <em>all</em> discourse to attempts at describing reality, when we clearly also do other things with our speech as well.
						</p>
						<p>
							Ordering someone <em>to do</em> something, for instance, is not an attempt to describe what that person <em>is</em> doing, and such a command cannot be <em>factually</em> right or wrong (although we could instead evaluate the command as <em>normatively</em> right or wrong). As I will elaborate later in my essay <a href="language">on language</a>, I hold moral claims to be more akin to such orders or commands than they are to descriptive claims, though they are often phrased in such as way as to project that morality as though it were a descriptive property of whatever is being evaluated; not unlike with social constructs, the focus of my next point of objection.
						</p>
						<hr />
						<p>
						...
						<p>
							But in rejecting constructiv<em>ism</em>, I am not at all rejecting the employment of social constructs in the description of social behavior. I am merely against the claim that <em>all</em> of reality is merely a social construct, and thus that there there can be no mere attempts (however fallible) at description of a universal reality that are not implicitly pushing some prescriptive agenda.
						</p>
						<p>
							Social constructs are actually defined in a sense by their unreality: to say, for example, that money is a social construct, is to say that there is nothing intrinsic about gold, or seashells, or any other token of currency, that makes it really money, that could be found in a thorough description of the gold or shells or whatever themselves. Nothing is <em>really</em> money in any universal sense; things are only subjectively <em>accepted as</em> money by some people, and to say that something is money (to some people) is really to say something about the people (namely, that they will accept the thing in trade), not about the thing itself, but phrased in such a way as to project what the people think about the thing onto the thing itself.
						</p>
						<p>
					...
					<section id="skepticism">
						...
						<figure class="invertible">
							<picture>
								...
								<img src="images/fideism-skepticism.jpg"
						...
						<p>
							Just as this principle of liberalism, or anti-cynicism, enables the cooperative institutional processes described in the previous essay <a href="dogmatism">against dogmatism</a>, the critical kind of skepticism I still support also enables an independence in our methods of <a href="epistemology">knowledge</a> and <a href="deontology">justice</a>; methodologically independent, but still institutionally cooperative, both at the same time. Nobody is required, on my account, to follow along with the social consensus of what is true or what is good; they are free to doubt that those things really are the best things to believe or intend, and to believe or intend contrary as they please.
						</p>
						<p>
							At least, until someone else &ndash; a social institutions or just another individual &ndash; can show reason why those things that an individual believes or intends are definitely <em>not</em> correct. In which case, by the same principle of criticism that permitted their dissenting opinion to begin with, they are obligated (in an epistemic or deontic sense as applicable), not necessarily to conform to the others' beliefs or intentions, but at least to change their own in some way to escape that criticism.
						</p>
					</section>

					<hr />

					<p><strong>Continue to the next essay, <a href="transcendentalism">Against Transcendentalism</a>.</strong></p>
