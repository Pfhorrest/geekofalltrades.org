				...
				<section>
					...
					<figure class="invertible">
						<picture>
							...
							<img src="images/philosophy-structure-language.jpg"
					...
					<p>
						In this essay I will start to explore the implications of commensurablism on various specific subtopics of philosophy, beginning with the <strong>philosophy of language</strong>.
					</p>
					<hr />
					<p>
						The philosophy of language is a central feature of one of the two major divisions of contemporary philosophy, the Analytic tradition, which is even named after its emphasis on philosophy being essentially about analysis of language. As elaborated already in my earlier <a href="metaphilosophy">metaphilosophy of Analytic Pragmatism</a>, I view such linguistic analysis as one of the two major poles of the structure of philosophy &ndash; the other being the practical application of philosophy to our actions, which I will address in detail at the conclusion of these essays, but which will even now influence my account of the philosophy of language.
					</p>
					<hr />
					<p>
						To briefly recap the arguments for the principles of <a href="commensurablism">commensurablism</a>, within the bounds of which I am going to explore the philosophy of language in this essay:
					</p>
					<ul>
						<li>
					...
					<p>
						My approach to satisfying these criteria hinges heavily on the concept of "speech-acts", as introduced by philosophers such as J.L. Austin and John Searle. A speech-act is simply something that you <em>do</em> by <em>saying</em> something. (To be clear, when I say "speech", "say", etc, throughout this essay, I don't mean only the making of noises with the human mouth, but any kind of linguistic communication, including writing, signing, etc).
					</p>
					<p>
						The clearest examples to illustrate the concept are special cases, such as when spouses at a wedding say "I do" in response to the question of whether they take each other to be spouses: they are not merely giving a factual answer to a question of fact, they are <em>performing the act</em> of marrying each other, which is done by saying certain words in a certain context. Similarly, when a judge says that they sentence a defendant in court to some punishment, they are not just describing something about themselves, they are <em>actively doing</em> the thing by saying that they do it.
					</p>
					<p>
						But beyond these special cases of ritual or ceremonial speech-acts, my philosophy of language hinges on how "merely" describing something is itself still <em>doing</em> something by speaking &ndash; describing is an action &ndash; and how speech can do many other things besides just describe, even outside of those iconic ritual or ceremonial cases that best demonstrate the concept of speech-acts. I hold that the meaning of all speech can be found by paying attention to what it is that someone is trying to <em>do</em> by uttering that speech.
					</p>
					<p>
					...
					<section id="statements-questions">
						<h3>On Statements and Questions</h3>
						<p>
					...
					<section id="impression-expression">
						<h3>On Impression and Expression</h3>
						<p>
							A much more subtle and more important dichotomy is that between what I call "expression" and "impression". I think the best way to illustrate this distinction is to consider a philosophical problem called "Moore's Paradox", put forth by G.E. Moore. The paradox is that while it is clearly possible for someone to disbelieve something that is nevertheless true &ndash; all sorts of people hold incorrect beliefs all the time &ndash; there seems to be something contradictory in that person themselves stating that fact: "X is true but I don't believe X".
						</p>
						<p>
						...
						<p>
							Similarly, expressive speech-acts, while they are indicative-like in the manner that they communicate, can be more imperative-like in their contents, such as "I think Bob ought to throw the ball", without <em>impressing</em> that opinion on anyone, much less Bob himself. But, of course, we <em>can</em> also merely express indicative-like, descriptive opinions, ala "I think Bob throws the ball", and importantly, I hold that we can also impress imperative-like, prescriptive opinions, ala "Bob ought to throw the ball". Expression and impression are about how an opinion is delivered; it's a separate matter as to what the contents of that opinion are.
						</p>
					</section>
					<section id="descriptive-prescriptive">
						<h3>On Description and Prescription</h3>
						<p>
						...
						<p>
							But although I agree with expressivists that moral utterances are not attempts to describe reality, I disagree with them about what moral utterances are trying to do instead, because their account renders morally utterances inapt to be true or false, and thus runs counter to my stance <a href="relativism">against relativism</a>. The short form of what I propose instead is that that I hold moral utterances to not be <em>expressing desires</em> any more than descriptive utterances <em>express perceptions</em>. Rather, just as descriptive utterances <em>impress beliefs</em>, I would say that moral, prescriptive utterances <em>impress intentions</em>.
						</p>
						<p>
						...
						<p>
							The analogous relation between this dichotomy and the dichotomy of expressivism versus more traditional views of moral semantics (called moral realism) should be obvious here, I hope. I find this Humeanism vs Kantianism to be a false dichotomy, and moral expressivism vs moral realism to be a false dichotomy as well. I think, like the Humean, that there are no such things as "moral beliefs" per se, and that moral utterances do not have any meaning to be found in some description of reality; but I also think, like the Kantian, that moral utterances do much more than just express desires incapable of being correct or incorrect. My position is not even that moral utterances <em>impress</em> desires, because I hold that desires are not the only mental state besides beliefs, and that beliefs are not the only cognitive mental states either, capable of being correct or incorrect.
						</p>
						<p>
							I use the term "opinion" to name the overarching category of mental states I am going to subdivide here, and I analyze an opinion as something I term an "attitude" toward something I term an "idea". The idea component of an opinion can be thought of as a mental picture of some possible, imaginable state of affairs, though it doesn't have to be literally visual: it is just the state of affairs that the opinion is <em>about</em>. But one can have different positions on different kinds of opinions about the same thing, and those different kinds of opinions about the same thing are what I mean by attitudes.
						</p>
						<section id="direction-of-fit">
							<h4>On Direction of Fit</h4>
							<p>
							...
							<p>
								The clearest example of this difference in attitude that I can think of is that, given the idea of a world where some people kill other people, I expect most will agree that that idea is "right" (not "wrong") in the sense that they agree with it as a <em>description</em> (most people, I expect, will agree that the world really is like that, and an idea of the world that doesn't feature such a thing is descriptively wrong), but simultaneously that it is "wrong" (not "right") in the sense that they will disagree with it as a <em>prescription</em> (most people, I expect, will agree that the world morally oughtn't be like that &ndash; whatever "morally oughtn't" means to them, which we're getting to &ndash; and that a world that features such a thing is prescriptively wrong).
							</p>
							<p>
						...
						<section id="order-of-opinion">
							<h4>On Order of Opinion</h4>
							<p>
							...
							<ul>
								<li>
									I call experiences with world-to-idea fit "appetites". These are composed of the raw inputs of things like pain, hunger, thirst, and so on. While sensations are the experiences that make us feel, on a raw unexamined level, like the world <em>is</em> some way, appetites are those experiences that make us feel, on a raw unexamined level, like the world <em>ought to be</em> some way. I visualize this as building two images, two ideas, in our minds: one of them a picture of the world as it is, meant to serve as a representation of the world, meant to fit the world; and the other of them a picture of the world as it ought to be, meant to serve as a guide for the world, meant for the world to fit. Sensations are those experiences that feed into that first picture, and appetites are those experiences that feed into that second picture.
								</li>
								<li>
						...
						<section id="indicative-imperative">
							...
							<p>
								A "yes" response to an indicative statement affirms that the listener agrees <em>with</em> it, <em>believes</em> what is claimed; while a "yes" response to an imperative statement affirms that the listener agrees <em>to</em> it, <em>intends</em> what is commanded; and "no" responses inversely for each, signalling that the belief or intention meant to be impressed has been rejected rather than accepted. Just as a descriptive statement is true if the belief it impresses is the correct thing to believe, so too a prescriptive statement is true if the intention it impresses is the correct thing to intend. How exactly to judge what beliefs or intentions are correct will be explored further in my later essays <a href="epistemology">on knowledge</a> and <a href="deontology">on justice</a>, respectively.
							</p>
						</section>
						<section id="order-of-opinion">
							<h4>On Embedding Problems</h4>
							<p>
								The major usual objection to views of moral semantics like this, that treat moral claims as something other than "ordinary" descriptive claims, is that on such an account, a non-descriptive sentence &ndash; being presumed to also be a non-cognitive one, and so incapable of being true or false &ndash; cannot straightforwardly be embedded in contexts where a descriptive sentence could be, such as a conditional (an "if... then..." sentence). This is called the embedding problem, or the Frege-Geach problem, after Peter Geach who developed it out of the work of Gottlob Frege.
							</p>
							<p>
					...
					<p>
						In addition to the descriptive and prescriptive types of claims that most of this essay has been about, and the ceremonial kinds of speech-acts that I've only briefly glossed past, there are also some kinds of claims that are neither quite descriptive nor prescriptive, at least in the empirical and hedonic senses discussed thus far, but are still closely related to them. The most central of these are philosophical claims, which as discussed in my earlier essay on <a href="metaphilosophy">metaphilosophy</a> are neither in the business of saying what in particular is real nor what in particular is moral, but rather are claims about what we <em>mean</em> in asking questions about those things, and <em>how to</em> go about answering them.
					</p>
					<p>
						Failing to make that distinction is another of the major common criticisms of verificationism as a complete theory of meaning, because on a verificationist account, the claims of verificationism itself &ndash; being philosophical claims, not empirical ones &ndash; are literally meaningless. Distinguishing such philosophical claims from either empirically grounded descriptions or hedonistically grounded prescriptions, just as in the aforementioned essay on metaphilosophy I distinguish philosophy itself from either empirical physical sciences or hedonistic ethical sciences, salvages my account of meaning from similar such critiques.
					</p>
					<p>
					...
					<p>
						There is much more to be said about those other two types of claims, and their relations to reality and morality, respectively. Over the next two essays I will go over many of those details, one focusing further on the <em>validity</em> of the structure of the content of speech-acts, as in logic and mathematics; and another focusing on the <em>effectiveness</em> of the style, presentation, and delivery of them, as in rhetoric and the arts.
					</p>

					<hr />

					<p><strong>Continue to the next essay, <a href="rhetoric">On Rhetoric and the Arts</a>.</strong></p>
