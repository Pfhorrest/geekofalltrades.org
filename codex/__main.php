...
-->
	...
	<p>
		(A major <a href="_reorg">reorganization and expansion of this work</a> is currently slowly under way;
		the version presented here was written in 2019 and updated through 2022 until that reorganization began).
	</p>
	<p>
	...
	<p>
		...
		All of that requires a framework of <a href="language">linguistic meaning</a> to make any sense of, along with different facets of communication such as <a href="logic">logic</a> and <a href="rhetoric">rhetoric</a>. And with all of that in place, we finally have the background needed to tackle the most practical questions of both personal and societal <a href="enlightenment">enlightenment</a> and <a href="empowerment">empowerment</a>, and leading a <a href="action">meaningful life</a>.
	</p>
	<hr />
	<p>
	...
	<section id="overview">
		...
		<p>
			In this sense, philosophy done badly, or only partially, is like an infectious disease; while philosophy done well, or more completely, is like a vaccination against that disease.
		...
		<p>
			Underlying all of that is a <a href="language">philosophy of language</a> based in speech-act theory, giving more or less a verificationist account of descriptive meaning; but, although accepting the non-descriptive impetus of moral non-cognitivism that usually accompanies that, nevertheless giving an ultimately cognitivist account of prescriptive meaning as well. Following that, and hinging on the notion of direction of fit that enables it, I give parallel accounts of, on one hand, the structure and content of speech-acts in <a href="logic">logic</a>, the relationship thereof to mathematics, and a segue into my mathematicist ontology; and, on the other hand, the packaging and delivery of speech-acts in <a href="rhetoric">rhetoric</a>, the relationship thereof to the arts, and a segue into my aestheticist axiology.
		</p>
		<p>
